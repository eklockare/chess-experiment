...
class PieceTests(unittest.TestCase):
    ...
    def test_is_valid_move_returns_move_result_no_pieces(self):
        ...
        self.failUnless(move_result == MoveResult(True, False, [
            GridCoord(6, 5),
            GridCoord(5, 5)], None))
    ...
    def test_is_invalid_move_returns_move_result_with_own_blocking_piece_end_square(self):
        ...
        self.failUnless(move_result == MoveResult(False, True, [GridCoord(1, 3)], self.other_piece_B4))
    ...
    def test_is_invalid_move_result_with_enemy_piece_blocking(self):
        ...
        self.failUnless(move_result == MoveResult(False, True,
            [GridCoord(2, 5)],
            self.other_piece_C6)
        )
